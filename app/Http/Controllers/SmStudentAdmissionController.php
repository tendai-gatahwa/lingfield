    ...
    public function studentDelete(Request $request)
    {
        try {
            ...
            try {
                ...
                // dd($student_detail->studentRecord->class->id);
                $data['class_id'] = $student_detail->studentRecord->class->id;
                $data['section_id'] = $student_detail->studentRecord->section->id;
                ...
                $this->sent_notifications('Enable/Disable_Student', $records, $data, ['Student', 'Parent']);
