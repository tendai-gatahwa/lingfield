...
class BehaviourRecordsController extends Controller
{
    ...
    public function assignIncidentDatatable(Request $request)
    {
        if ($request->ajax()) {
            ...
            $all_students =  SmStudent::with('studentRecords', 'studentRecords.class', 'studentRecords.section')->withCount('incidents')->withSum('incidents', 'point')->whereIn('id', $student_records)
