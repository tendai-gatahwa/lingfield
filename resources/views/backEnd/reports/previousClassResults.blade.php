                    ...
                    {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'previous-student-record', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'id' => 'admissionNoSearch']) }}
                        <div class="row align-items-end"> 
                            <input type="hidden" name="url" id="url" value="{{URL::to('/')}}"> 
                                ...
                                <div class="col-lg-4 col-xl-5 col-md-4 mt-30-md md_mb_20" id="selectRecordDiv">
                                ...
                                <div class="col-lg-3 col-xl-2 col-md-4 col-sm-4 mt-4 mt-lg-0">
                                    <button type="submit" class="primary-btn small fix-gr-bg search-btn">
