                                    ...
                                    @if (is_show('document_file_1'))
                                        @if ($student_detail->document_file_1 != '')
                                            <tr class="d-flex">
                                                ...
                                                <td class="col-6">{{ showDocument(@$student_detail->document_file_1) }}
                                                </td>
                                                <td class="col-4">
                                    ...
                                    @if (is_show('document_file_2'))
                                        @if ($student_detail->document_file_2 != '')
                                            <tr class="d-flex">
                                                ...
                                                <td class="col-6">{{ showDocument(@$student_detail->document_file_2) }}
                                                </td>
                                                <td class="col-4">
                                    ...
                                    @if (is_show('document_file_3'))
                                        @if ($student_detail->document_file_3 != '')
                                            <tr class="d-flex">
                                                ...
                                                <td class="col-6">{{ showDocument(@$student_detail->document_file_3) }}
                                                </td>
                                                <td class="col-4">
                                    ...
                                    @if (is_show('document_file_4'))
                                        @if ($student_detail->document_file_4 != '')
                                            <tr class="d-flex">
                                                ...
                                                <td class="col-6">{{ showDocument(@$student_detail->document_file_4) }}
                                                </td>
                                                <td class="col-4">
                            ...
                            <div class="col-lg-12 mt-30">
                                <div class="row no-gutters input-right-icon">
                                    <div class="col">
                                        <div class="primary_input">
                                            <input class="primary_input_field" type="text"
                                                id="placeholderFileFourName" placeholder="Document"
                                                disabled>
