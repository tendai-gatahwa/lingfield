                                        ...
                                        <div class="primary_input mb-15">
                                            ...
                                            <div class="primary_datepicker_input">
                                                <div class="no-gutters input-right-icon">
                                                    ...
                                                    <button class="btn-date" style="top: 55% !important;"
                                                        data-id="#admission_date" type="button">
                                    ...
                                    @if (is_show('guardians_email') || is_show('guardians_phone'))
                                        <div class="col-lg-6 text-right">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-5">
                                                    <button class="primary-btn-small-input primary-btn small fix-gr-bg mt-4"
                                            ...
                                            <div class="col-lg-6">
                                                <div class="primary_input ">
                                                    ...
                                                    <textarea class="primary_input_field form-control{{ $errors->has('guardians_address') ? ' is-invalid' : '' }}"
                                                        cols="0" rows="3" name="guardians_address"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="primary_input ">
                                            ...
                                            <textarea class="primary_input_field form-control{{ $errors->has('previous_school_details') ? ' is-invalid' : '' }}"
                                                cols="0" rows="3" name="previous_school_details">{{ old('previous_school_details') }}</textarea>
