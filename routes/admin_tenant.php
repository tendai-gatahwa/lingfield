...
Route::group(['middleware' => ['XSS', 'subscriptionAccessUrl']], function () {
    ...
    Route::get('test-in',function(){
            ...
            'inappliveclass' => array(
                ...
                'child' => array(
                    ...
                    'inappliveclass.setting' => array(
                        ...
                        'inappliveclass.parent-in-app-live-class' => array (
                        'module' => 'InAppLiveClass',
                        'sidebar_menu' => NULL,
                        'name' => 'Live Class',
                        'lang_name' => 'inappliveclass::inappliveclass.in_app_live_class',
                        'icon' => NULL,
                        'svg' => NULL,
                        'route' => 'inappliveclass.parent-in-app-live-class',
                        'parent_route' => 'inappliveclass',
                        'is_admin' => 0,
                        'is_teacher' => 0,
                        'is_student' => 0,
        ...
        foreach($inappliveclassMenus as $menu){
